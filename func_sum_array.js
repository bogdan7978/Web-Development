...
//To get the sum of an array you have to loop over it and store the results in another array
const sum = [1, 3, 5, 7, 9, 11].reduce((acc, cur) => acc + cur, 0); // arguments given to 'reduce' are 'accumulative' and 'cuurent value'
console.log(sum)

// Method without built-in array function
function sum2 (arr) {
    let total = 0; // using 'let' allows the variable to be updated as opposed to 'const'
